  ...
  <footer className="bg-surface-container-lowest border-t border-outline-variant/30 py-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
      <div className="col-span-1 md:col-span-2">
        ...
        <p className="text-xs text-primary/50">© 2026 Smile Ezee Dentistry. All Rights Reserved.</p>
      </div>
      <div>
...
const BookingModal = ({ isOpen, onClose }: { isOpen: boolean, onClose: () => void }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    window.open(`https://wa.me/918072117912?text=${encodeURIComponent(message)}`, '_blank');
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans overflow-x-hidden">
      ...
      <FloatingWhatsApp 
        phoneNumber="8072117912"
        accountName="Smile Ezee Dentistry"
        avatar="https://i.postimg.cc/9MzdQLpr/SEzee.jpg"
